...
if __name__ == '__main__':
    ...
    Path = 'processed_datasets/final_33train.csv'
    ...
    Path = 'processed_datasets/final_33test.csv'
    ...
    total_class=preprocess.get_totalclass('processed_datasets/final_33test.csv')
